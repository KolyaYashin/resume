    ...
    <div id="app">
        <div class="resume">
            <div class="base">
                <div class="profile">
                    <div class="photo">
                        <img :src="image" alt="моё фото">
                        <i class="fas fa-rocket"></i>
                    </div>
                    <div class="info">
                        <h1 class="name">Николай Яшин</h1>
                        <h2 class="job">Ml developer</h2>
                    </div>
                </div>
                <div class="about">
                ...
                <div class="contact">
                    ...
                    <div class="address"><a href="https://goo.gl/maps/fiTBGT6Vnhy"><i
                        class="fas fa-map-marker"></i><span>Provo, Utah</span></a>
                    </div>
                    <div class="email"><a href="mailto:astronaomical@gmail.com"><i class="fas fa-envelope"></i><span>astronaomical</span></a>
                    </div>
            ...
            <div class="func">
                ...
                <div class="edu">
                    ...
                    <ul>
                        <li>
                            <span>Bachelor of Science<br>Web Design and Development</span><small>BYU-Idaho</small><small>Jan.
